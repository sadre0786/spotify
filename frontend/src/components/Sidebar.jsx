  ...
  return (
    <div className="w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex">
      ...
      <div className="bg-[#121212] h-[85%] rounded">
        ...
        <div className="p-4 bg-[#121212] rounded font-semibold flex flex-col items-start justify-start gap-1 pl-1 mt-4">
        ...
        {user && user.role === "admin" && (
          <button
            ...
            className="px-4 py-1.5 bg-white cursor-pointer text-black text-[15px] rounded-full mt-4"
          >
            Admin Dashboard
          </button>
        )}
